...
TEST_CASE("Interface extension in schema", "[extension]") {
  SECTION("Read schema including interface extension") {
    FILE *fp = fopen("./feature-tests/interface_extension_schema.graphql", "r");
